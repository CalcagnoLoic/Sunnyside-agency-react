...
const Header = () => {
    return (
        <div className='bg-header-mobile md:bg-header-desktop h-screen bg-cover bg-no-repeat bg-scroll bg-center relative' >
            ...
            <h1 className='flex justify-center text-5xl font-bold text-center text-white uppercase tracking-widest lg:text-6xl lg:font-extrabold'>We are creatives</h1>
            <img src={arrow} alt="Flèche arrow down" className='animate-bounce absolute bottom-52 left-40 w-16 md:w-8 md:left-1/2 md:bottom-80'/>
        </div>
    )
}
