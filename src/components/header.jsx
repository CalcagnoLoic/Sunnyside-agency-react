...
const Header = () => {
    return (
        <div className='bg-header-mobile md:bg-header-desktop h-screen bg-cover bg-no-repeat bg-scroll bg-center relative' >
            <nav className='flex p-6 place-content-between mb-40 md:mb-20'>
                <img src={logo} alt="Logo sunnyside" className='w-32'/>
                <img src={hamburger} alt="Menu" className='md:hidden hover:cursor-pointer h-5 w-6' />
            </nav>
            <h1 className='flex justify-center text-5xl font-bold text-center text-white uppercase tracking-widest'>We are creatives</h1>
